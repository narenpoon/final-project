...
from model import labels_test,model_predictions
...
tfid, Input = pickle.load(
    open('Overall.pkl', 'rb'))  # loads feature extraction model from binary file i.e,feature.pkl
